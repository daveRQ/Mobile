...
import {
    Container, Content, Form, Item, Input, Label, Picker, Icon,
    Text, DatePicker, Button
} from 'native-base';
...
class Personal_editar extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isReady: false,
                        ...
                        <Content>
                            <Form>
                                ...
                                <Row>
                                    ...
                                    <Col style={{
                                        flex: 1.13, justifyContent: 'center', alignItems: 'center',
                                    ...
                                    <Col style={{ flex: 4 }}>
                                        ...
                                        <Row style={{ justifyContent: 'center', alignItems: 'center', padding: '2%' }}>
                                            <Button style={{ backgroundColor: '#ECB787', width: '50%', justifyContent: 'center' }}
                                                onPress={() => this.props.navigation.navigate('PersonalEditarFunciones')}>
                                                <Text>Funciones</Text>
                                            </Button>
                                        </Row>
                                    </Col>
...
export default Personal_editar;
