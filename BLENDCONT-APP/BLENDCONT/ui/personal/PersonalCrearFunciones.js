...
class PersonalCrearFunciones extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isReady: false,
                                ...
                                <Body>
                                    <Text style={styles.checks}>  Iniciar y Cerrar Dia Operacional</Text>
														...
														<Row style={{justifyContent: 'center'}}>
															<Button rounded style={{backgroundColor: '#ECB787', width: '50%', justifyContent: 'center'}}
																onPress={() => this.props.navigation.navigate('PersonalList')}>
																<Text>Crear Personal</Text>
															</Button>
														</Row>
                        </Content>
                    </Row>
...
export default PersonalCrearFunciones;